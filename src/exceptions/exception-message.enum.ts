export enum ExceptionMessage {
  ...
  AccommodationNotFound = 'Accommodation not found. Please try again.',
  AccommodationExist = 'Accommodation already exists.',
  ...
  RateNotFound = 'Rate not found. Please try again.',
