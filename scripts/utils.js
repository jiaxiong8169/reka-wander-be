...
// function createReservations(collectionName) {
//   // get all dummy users
//   const users = db.users.find({
//     email: {
//       $nin: [
...
//   // add reservations for the dummy users
//   const startDate = [0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5];
//   const commentChoices = [
//     'Good service',
//     'Excellent!',
//     'I will definitely come back again.',
...
//       const rating = ratingChoices[Math.floor(seed * ratingChoices.length)];
//       // insert review
//       const review = db.reservations.insertOne({
//         targetId: d._id,
//         userId: u._id,
//         userName: u.name,
//         userProfileSrc: '',
